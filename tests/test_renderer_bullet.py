...
class TestBulletRenderer(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.obj_label = "obj_000001"  # TODO: current limitation: label must be equal to object name
    ...
    def test_scene_renderer(self):
        ...
        renderer = BulletSceneRenderer(asset_dataset=self.rigid_object_dataset, gpu_renderer=False)

        renderings = renderer.render_scene(self.object_datas, self.camera_datas,
    ...
    def test_batch_renderer(self):
        ...
        renderer = BulletBatchRenderer(asset_dataset=self.rigid_object_dataset,
                                       n_workers=0,
                                       preload_cache=True,
                                       gpu_renderer=False)
