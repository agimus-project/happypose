...
def main():
    ...
    if args.bop_extra_files:
        if args.bop_extra_files == "tless":
            ...
            gdrive_download(
                "bop_datasets/tless/all_target_tless.json", BOP_DS_DIR / "tless",
            )
        elif args.bop_extra_files == "ycbv":
            # Friendly names used with YCB-Video
            gdrive_download(
                "bop_datasets/ycbv/ycbv_friendly_names.txt", BOP_DS_DIR / "ycbv",
            )
    ...
    if args.ycbv_compat_models:
        ...
        gdrive_download(
            "bop_datasets/ycbv/models_bop-compat_eval", BOP_DS_DIR / "ycbv",
        )
